<button class="btn px-12 border-none text-gray-50 bg-blue-500 hover:bg-blue-600 mb-4" onclick="my_modal_4.showModal()">Add Teachers (CSV)</button>
<dialog id="my_modal_4" class="modal">
    <div class=" modal-box w-11/12 max-w-5xl">
        <form method="dialog">
            <button class="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">✕</button>
        </form>
        <h3 class="font-bold text-lg mb-8">Add teachers.</h3>
        <!-- Form start -->
        <form method="post" action = "../../../php/teacher/bulk_add_teachers.php" enctype="multipart/form-data">
