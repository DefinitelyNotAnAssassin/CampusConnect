<button class="btn px-12 border-none text-gray-50 bg-blue-500 hover:bg-blue-600 mb-4" onclick="my_modal_4.showModal()">Add Schedules (CSV)</button>
<dialog id="my_modal_4" class="modal">
    <div class=" modal-box w-11/12 max-w-5xl">
        <form method="dialog">
            <button class="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">✕</button>
        </form>
        <h3 class="font-bold text-lg mb-8">Add schedules (Bulk).</h3>
        <!-- Form start -->
        <form method="post" action = "../../../php/schedules/bulk_add_schedules.php" enctype="multipart/form-data">
            <input type="file" name="schedules_csv" accept=".csv" required = "">
